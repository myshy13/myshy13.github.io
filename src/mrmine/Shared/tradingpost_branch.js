...
function determineTimeValueOfTradeType(tradeType, tradeSubtypeIndex = null)
{
    ...
    switch(tradeType)
    {
        ...
        case TRADE_TYPE_RELIC:
            ...
            {
                resultTimeValue =  doBigIntDecimalMultiplication(43200n, Math.pow(excavationRewards[tradeSubtypeIndex].rarity, 2.5));
            }
            break;
        case TRADE_TYPE_BUILDING_MATERIAL:
            resultTimeValue = 600n;
    ...
    switch(tradeType)
    {
        ...
        case TRADE_TYPE_ORE:
            ...
            else if(!isPayment && otherType == TRADE_TYPE_ORE)
            {
                ...
                var quantity = (((BigInt(timeValue) * 100n) / determineTimeValueOfTradeType(TRADE_TYPE_ORE)) * otherValue / worldResources[tradeSubtype].sellValue) / 100n;
